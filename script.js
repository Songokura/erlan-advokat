...
var I18N = {
  kk: {
    ...
    'meta.desc':'10 млн теңгеден жоғары ірі даулар: қарыз өндіру, мүлікті бөлу, құрылыс салушылар, жол апаттары, салық және экономикалық істер. 2001 жылдан бері тәжірибе, сенім білдірушілердің істері бойынша 4,6 млрд теңгеден астам өндірілген.',
    ...
    'f2.v':'4,6 млрд ₸','f2.l':'сенім білдірушілердің істері бойынша өндірілді',
    ...
    'op.total':'сот шешімдері бойынша сенім білдірушілерге өндіріліп қайтарылды',
    'c1.h':'Ұзаққа созылған құрылыс: екі салушыдан үлескерлердің ақшасы',
    'c1.p':'шарттар бұзылды, сомалар ортақ жауапкершілікпен өндірілді, тұрғын кешен жобалық құжаттамасымен үлескерлер кооперативіне берілді',
    'c2.h':'Сол кешеннің екінші тобы',
    'c2.p':'алдын ала сатып алу-сату шарттары бұзылды, төленген сома ортақ жауапкершілікпен өндірілді',
    'c3.h':'Тағы бір тоқтап қалған тұрғын кешен',
    'c3.p':'сомалар өндіріліп, кооперативке үлескерлердің жарнасы ретінде берілді',
    'c4.h':'Үлескерлік құрылыстағы қылмыстан келген зиян',
    'c4.p':'апелляция шешімді өзгертті: салушы шаршы метрмен емес, ақшамен береді',
    'c5.h':'Кооперативке қарсы екі үлескер',
    'c5.p':'бірінші саты бас тартты, апелляция шешімнің күшін жойып, талапты толық қанағаттандырды',
    'c6.h':'Ақша қолхатпен сақтауға берілген',
    'c6.p':'баж бен өкіл шығындарымен бірге толық қайтарылды',
    'c7.h':'Турфирманың он клиенті',
    'c7.p':'тапсырма шарттары бұзылды, әрқайсысына төлемі қайтарылды',
    'c8.h':'Қызмет көрсету шарты бойынша қарыз',
    'c8.p':'баж бен өкіл шығындарымен бірге өндірілді',
    'def.ask':'Ал менен талап етсе ше?',
    'def.h':'Мен бермеген істер',
    'def.lead':'Жұмыстың екінші жартысы: алу емес, бермеу. Мұнда нәтиже - сенім білдірушіге қойылған талаптан бас тарту немесе талаптың алынып тасталуы.',
    'c9.h':'Кеден баж бен салық қосымша есептеді',
    'c9.p':'бірінші саты бас тартты, апелляция хабарламаны толығымен заңсыз деп таныды',
    'c10.h':'Кәсіпкерден жалақы талап етілді',
    'c10.p':'еңбек шарты жасалмаған, талап қанағаттандырылмады',
    'c11.h':'Жүк көлігі қатысқан ЖКО бойынша әкімшілік іс',
    'c11.a':'Куәлік сақталды',
    'c11.p':'құқық бұзушылық құрамы болмағандықтан іс жүргізу тоқтатылды',
    'c12.h':'Жазатайым оқиғадағы жұмыс берушінің кінәсі туралы акт',
    'c12.a':'100 % кінә алынды',
    'c12.p':'апелляция комиссияның тұжырымын жойып, тексеруді қайта жүргізуге міндеттеді',
    'st.won':'Жеңіс','st.got':'Өндірілді','st.kept':'Қорғалды',
    'st.back':'Қайтарылды','st.off':'Есептен шығарылды','st.no':'Бас тартылды','st.stop':'Тоқтатылды',
    'op.note':'Бұл - сот шешімдерінен алынған үзінділер. Көшірмелерін кездесуде көрсетемін, сонда сіздің ісіңізбен салыстырамыз. Сенім білдірушілердің аты-жөні мен іс деректемелерін жарияламаймын.',
